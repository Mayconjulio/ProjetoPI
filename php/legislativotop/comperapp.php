...
?>  </a>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-header">
                <center><h4 class="card-title"> Comissões Permanentes</h4>
                <center><a class="btn btn-danger" href="./acesso" role="button">Voltar</a></center>
                <?php
  $query = $DBcon->query("SELECT * FROM comissoesp ORDER BY id DESC");
  ...
  { 
      ...
      {         
          $nome = htmlspecialchars($enqueteee['comissao']);
          $sobre = htmlspecialchars($enqueteee['nomes']);
  
          echo '
          <div class="card" style="width: 18rem;">
              <div class="card-body">
                  <h5 class="card-title">'.utf8_decode($nome).'</h5>
                  <p class="card-text">'.$sobre.'</p>
              </div>
          </div>';
      }
  }
