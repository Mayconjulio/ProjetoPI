...
$query4 = "INSERT INTO reqcidadao(tipo,nome,email,telefone,mensagem) VALUES('LM','$nome','$email','$zap','$mensagem')";
  if ($DBcon->query($query4))
  {
    $msg2 = "<br><div class='alert alert-info' role='alert'>
  <strong>Pronto!</strong> Sugestão enviada com sucesso.
</div>";
  }
else 
{
...
<head>
  ...
  <title>
    Sugerir Lei Municipal - Câmara Municipal de <?php echo $nomecam;?>
  </title>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <center><h4 class="card-title">Sugerir Lei Municipal</h4></center>
              </div>
...
if(isset($msg2)){ echo $msg2; }
            ...
            <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Sugestão de Lei</label>
                        <textarea rows="4" cols="80" class="form-control" placeholder="Sugestão de Lei" name="sobreen" required></textarea>
                      </div>
                    </div>
                  </div>
