...
<head>
  ...
  <title>
    Dúvidas Frequentes - Câmara Municipal de     <?php 
  echo $nomecam;
?>  
  </title>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-header">
                <center><h4 class="card-title"> Dúvidas Frequentes</h4>
                <center><a class="btn btn-danger" href="./acesso" role="button">Voltar</a></center>
                <?php
  //aa
  $query=$DBcon->query("SELECT * FROM duvidasfrequentes ORDER BY id DESC");
  $count=$query->num_rows;
  if($count>=1)
  { 
  while($enqueteee=$query->fetch_array())
  {         
         $nome = $enqueteee['duvida'];
         $sobre = $enqueteee['resposta'];
