...
<head>
  ...
  <title>
  Câmara Municipal de <?php echo $nomecam;?> - Requerimentos
  </title>
...
<body class="">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-header">
                <center><h4 class="card-title"> Requerimentos</h4>
                <center><a class="btn btn-danger" href="./acesso" role="button">Voltar</a></center>
                <?php
  //aa
  $query=$DBcon->query("SELECT * FROM reqs ORDER BY id DESC");
  ...
  {         
         ...
         $sobre = $enqueteee['info'];

         echo '<div class="card">
         <h5 class="card-header"><strong>'.$nome.'</strong></h5>
         <div class="card-body">
