...
if (isset($_POST['novaenquete'])) {
    ...
    $query4 = "INSERT INTO indica(titulo,info) VALUES('$titulo','$sobre')";
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <center><h4 class="card-title">Indicações</h4></center>
              </div>
...
<?php
    ...
    <input type="text" class="form-control" name="lastide" placeholder="<?php echo $lastid; ?>" value="<?php echo $lastid; ?>" hidden>
                      ...
                      <div class="form-group">
                        <label>Título da indicação</label>
                        <input type="text" class="form-control" placeholder="Título da indicação" name="tituloen">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder="Descrição completa da indicação" name="sobreen"></textarea>
                      </div>
                    </div>
                  </div>
