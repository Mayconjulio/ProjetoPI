...
$query4 = "INSERT INTO reqs(titulo,info) VALUES('$titulo','$sobre')";
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <center><h4 class="card-title">Requerimentos</h4></center>
              </div>
...
<?php
    ...
    <input type="text" class="form-control" name="lastide" placeholder="<?php echo $lastid; ?>" value="<?php echo $lastid; ?>" hidden>
  </div>
                      <div class="form-group">
                        <label>Título do requerimento</label>
                        <input type="text" class="form-control" placeholder="Título do requerimento" name="tituloen">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Descrição completa da indicação</label>
                        <textarea rows="4" cols="80" class="form-control" placeholder="Descrição completa do requerimento" name="sobreen"></textarea>
                      </div>
                    </div>
                  </div>
                  <center><button type="submit" class="btn btn-info" name="novaenquete">Confirmar</button></center>
                  <br><br>
                  <center><a class="btn btn-danger" href="administracaopr" role="button">Voltar</a></center>
</form>';
    }
    else
    {
