...
$query4 = "INSERT INTO mocoes(titulo,info) VALUES('$titulo','$sobre')";
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <center><h4 class="card-title">Moções</h4></center>
              </div>
...
<?php
    ...
    <input type="text" class="form-control" name="lastide" placeholder="<?php echo $lastid; ?>" value="<?php echo $lastid; ?>" hidden>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Título da moção" name="tituloen">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Descrição completa da moção</label>
                        <textarea rows="4" cols="80" class="form-control" placeholder="Descrição completa da moção" name="sobreen"></textarea>
                      </div>
                    </div>
                  </div>
