...
$query4 = "INSERT INTO tvcamara(titulo,link) VALUES('$titulo','$sobre')";
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <center><h4 class="card-title">TV Câmara</h4></center>
              </div>
...
<?php
    ...
    <input type="text" class="form-control" name="lastide" placeholder="<?php echo $lastid; ?>" value="<?php echo $lastid; ?>" hidden>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Título do vídeo" name="tituloen">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder="Link do vídeo do Youtube" name="sobreen"></textarea>
                      </div>
                    </div>
                  </div>
