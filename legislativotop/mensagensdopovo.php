...
<body class="">
  ...
  ?>  
    ...
    <div class="main-panel" id="main-panel">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <center><label><p style="color:white;">Mensagens do Povo</p></label></center>
      ...
      <?php
$query=$DBcon->query("SELECT * FROM mensagens WHERE para=".$id." ORDER BY id DESC LIMIT 100");
...
<div class="row g-0">
  <div class="col-md-12">
    <div class="card-body">
      <center><h5 class="card-title">De: '.$nome.'<br>'.$titulo.'</h5></center>
